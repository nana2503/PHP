        ...
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 pd5  ">
          <ol class="breadcrumb breadcrumb-arrows" itemscope="" itemtype="http://schema.org/BreadcrumbList">
            <li itemprop="itemListElement" itemscope="" itemtype="http://schema.org/ListItem">
              <a class="text-dark" href="TrangChu.php" target="_self" itemprop="item"><span itemprop="name">Trang chủ</span></a>
              <meta itemprop="position" content="1">
            </li>
            <li itemprop="itemListElement" itemscope="" itemtype="http://schema.org/ListItem">
              <a class="text-dark" href="DanhMuc.php" target="_self" itemprop="item">
                <span itemprop="name">Bánh</span>
              </a>
            ...
            <div class="col-lg-6 col-sm-12 col-xs-12 product-content-img">
              <div class="product-gallery">
                <div class="product-image-detail box__product-gallery scroll">
                  <div class="">
                    <img class="product-image-feature" src="../../adminpage/ElaAdmin/upload/<?php echo $item['Product_FirstImg'] ?>" style="width: 300px; height: 270px; object-fit: cover;">
                  </div>
                </div>
                <div class="product-gallery__thumbs owl-carousel owl-loaded owl-drag" data-nav="true" data-margin="15" data-sm-items="4" data-xs-items="4" data-md-items="4" data-lg-items="5">
                  <div class="owl-stage-outer">
                    <div class="owl-stage" style="transform: translate3d(0px, 0px, 0px); transition: all 0s ease 0s; width: 87px;">
                      <div class="owl-item active" style="width: 350px; padding: 0 32px">
                        <div class="row">
                          <div style="width: 100px; height: 100px; object-fit: cover;" class="col-4 product-gallery__thumb active" data-image-large="../../adminpage/ElaAdmin/upload/<?php echo $item['Product_FirstImg'] ?>">
                            <img src="../../adminpage/ElaAdmin/upload/<?php echo $item['Product_FirstImg'] ?>" alt="" srcset="">
                          </div>
                          <div style="width: 100px; height: 100px; object-fit: cover;" class="col-4 product-gallery__thumb active" data-image-large="../../adminpage/ElaAdmin/upload/<?php echo $item['Product_SecondImg'] ?>">
                            <img src="../../adminpage/ElaAdmin/upload/<?php echo $item['Product_SecondImg'] ?>" alt="" srcset="">
                          </div>
                          <div style="width: 100px; height: 100px; object-fit: cover;" class="col-4 product-gallery__thumb active" data-image-large="../../adminpage/ElaAdmin/upload/<?php echo $item['Product_ThirdImg'] ?>">
                            <img src="../../adminpage/ElaAdmin/upload/<?php echo $item['Product_ThirdImg'] ?>" alt="" srcset="">
                          </div>
                        </div>
                      </div>
                    </div>
