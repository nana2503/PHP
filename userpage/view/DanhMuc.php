...
<head>
    ...
    <title>Bánh kem - Freshgarden</title>
        ...
        <?php foreach ($data as $item) { ?>
            <div class="px col-lg-3 col-md-3 col-sm-6">
                <div class="text-center my-4">
                    <a href="DanhSachSP.php?id=<?php echo $item['Category_Id']?>"><img src="../../adminpage/ElaAdmin/upload/<?php echo $item['Category_Image']?>" class="sanpham dont_scale wow animated fadeInDown" data-animation="fadeInDown" alt=""></a>
                    <h5><a class="tensanpham" href="DanhSachSP.php?id=<?php echo $item['Category_Id']?>"><?php echo $item["Category_Name"]?></a></h5>
                </div>
            </div>
        <?php
        } ?>
